...
- [Data from the Washington Post](https://cronkitedata.s3.amazonaws.com/xlfiles/wapo-shootings.xlsx)  for use in this tutorial
- [Documentation from the Post's github site](https://github.com/washingtonpost/data-police-shootings#about-the-data). This data refers to the original "V1" data.
::: 


::: callout-important

The column names and We will look at the documentation under ["V1" in their github repo](hhttps://github.com/washingtonpost/data-police-shootings/tree/master/v1) . The data was last updated in early 2022, before the Post made changes. This copy includes all shootings through the end of 2020 -- 2021 was removed because too much of the data downloaded at the time was missing. 
...
- The Post says this is a list of fatal shootings, but doesn't say what happens if more than one person is killed. The [2019 shooting of D'Angelo Brown & Megan Rivera in West Memphis](https://www.wbtv.com/2019/03/15/dash-cam-footage-aided-investigation-into-deadly-police-shooting-no-charges-officers/)  is shown as two rows in the data  even though it was one event. So each row  might  be considered a shooting "victim",  a "suspect" or a shooting "fatality" rather than a "shooting". The Post's documentation suggests that this is the case, but finding that double shooting confirms it. 
